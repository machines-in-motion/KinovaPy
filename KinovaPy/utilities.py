"""
Credits: https://github.com/Kinovarobotics/Kinova-kortex2_Gen3_G3L
"""
...
def parseConnectionArguments(parser=None):
    # Create a new ArgumentParser per call to avoid duplicate option registration
    # when this function is invoked multiple times in an interactive session.
    if parser is None:
    ...
    # Use parse_known_args to ignore ipykernel / Jupyter launcher arguments when called inside notebooks
